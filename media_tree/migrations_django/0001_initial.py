    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(related_name='created_by', blank=True, editable=False, to=settings.AUTH_USER_MODEL, null=True, verbose_name='created by')),
                ('modified_by', models.ForeignKey(related_name='modified_by', blank=True, editable=False, to=settings.AUTH_USER_MODEL, null=True, verbose_name='modified by')),
                ('parent', models.ForeignKey(related_name='children', verbose_name='folder', blank=True, to='media_tree.FileNode', null=True)),
            ],
            options={
